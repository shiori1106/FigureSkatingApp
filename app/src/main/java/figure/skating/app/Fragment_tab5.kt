...
import kotlinx.android.synthetic.main.fragment_tab4.recyclerView_tab4
import kotlinx.android.synthetic.main.fragment_tab5.*

class Fragment_tab5: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val dataRealmResults = mRealm.where(ResultData::class.java)
            .equalTo(ResultData::gender.name, "F")
